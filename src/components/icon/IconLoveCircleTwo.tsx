...
export default function IconLoveCircleTwo(props: Props) {
      return (
            <>
                  <div className={`w-[60px] h-[60px] rounded-full bg-white flex items-center justify-center ${props.className} bounce4`}>
