                  ...
                  <ViewMobileMain>
                        <main className='relative z-[10]'>
                              ...
                              <section className='flex flex-col items-center justify-center gap-y-[10px]'>
                                    ...
                                    <h2 className='font-bold text-[24px] leading-[24px] tracking-[-3%] text-center text-brand block z-[2]'>Sign in to your account</h2>
                              </section>
                              ...
                              <form action="#" className='lg:mt-[37px] mt-[30px] flex flex-col z-[2]'>
                                    ...
                                    <div className='flex items-center justify-center gap-x-[14px] mb-[50px]'>
                                    ...
                                    <div className='flex flex-col'>
                                          ...
                                          <Link href={'/auth/register'} className='font-normal text-sm leading-[21px] tracking-[-3%] text-center text-[#696969] block z-[2]'>
